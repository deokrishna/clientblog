...
const AddBlog = () => {
  ...
  const sendRequest = async () => {
    const res = await axios.post('https://serverblog-weld.vercel.app/api/blog/add',
      {
        title: inputs.title,
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        <Box border={3}
          borderColor="linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(108,108,218,1) 76%, rgba(0,212,255,1) 100%)"
          borderRadius={10}
          ...
          <Typography
            ...
            variant='h2' textAlign={'center'}>Post Your Blog</Typography>
